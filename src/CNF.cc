...
{
  if (phi)
    {				// skip over null problems
      if (already_satisfied (phi))
	{			// phi is satisfied
 ...
 */
void
copy_variables (problem from, problem to)
{
 ...
 */
void
copy_clauses (problem from, problem to)
{
 ...
 */
clause
copy_clause (clause from, int size)
{
 ...
 */
problem
introduce (problem phi, int variable, assignment a)
{
